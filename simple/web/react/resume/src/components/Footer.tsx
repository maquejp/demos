...
const Footer: React.FC<FooterProps> = ({ personalInfo }) => {
  return (
    <footer className="relative py-12 px-6 bg-linear-to-br from-primary-900 via-secondary-900 to-accent-900 text-white">
      <div className="absolute inset-0 bg-black/20"></div>
      <div className="relative z-10 max-w-6xl mx-auto text-center">
        <div className="mb-6">
          <div className="w-20 h-20 mx-auto bg-linear-to-br from-white to-gray-100 rounded-full flex items-center justify-center shadow-2xl mb-4">
