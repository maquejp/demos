...
const CertificationsSection: React.FC<CertificationsSectionProps> = ({
  ...
  return (
    <section className="py-16 px-6 bg-linear-to-br from-primary-100 via-secondary-50 to-accent-100">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-12">
          <h2 className="text-4xl md:text-5xl font-bold gradient-text mb-4">
            Certifications & Professional Development
          </h2>
          <div className="w-32 h-1 bg-linear-to-r from-primary-500 to-accent-500 mx-auto rounded-full"></div>
        </div>

        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {certifications.map((cert: Certification, index) => (
            <div key={index} className="group relative">
              <div className="absolute inset-0 bg-linear-to-br from-primary-300/30 to-accent-300/30 rounded-2xl transform -rotate-2 group-hover:rotate-2 transition-transform duration-300"></div>
              ...
              <div className="relative bg-white/90 backdrop-blur-sm rounded-2xl shadow-xl p-6 hover-lift border border-primary-200">
                ...
                <div className="mt-4 pt-4 border-t border-gray-100">
                  <div className="w-full h-1 bg-linear-to-r from-primary-200 via-secondary-200 to-accent-200 rounded-full"></div>
                </div>
              </div>
            </div>
          ))}
