...
const Header: React.FC<HeaderProps> = ({
  ...
  return (
    <header className="relative overflow-hidden">
      <div className="absolute inset-0 bg-linear-to-br from-primary-600 via-secondary-600 to-accent-500 animate-gradient-xy"></div>
      <div className="absolute inset-0 bg-black opacity-20"></div>

      <div className="relative z-10 py-16 px-6">
        <div className="max-w-6xl mx-auto text-center">
          <div className="floating mb-6">
            <div className="w-32 h-32 mx-auto bg-linear-to-br from-white to-gray-100 rounded-full flex items-center justify-center shadow-2xl">
