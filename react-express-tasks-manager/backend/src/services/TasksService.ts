      ...
      return {
        ...
        data: [
          ...
          },
          {
            ...
            description:
              'Build responsive homepage with modern design patterns',
            status: 'todo',
            priority: 'high',
            assignedTo: ['1'],
            createdBy: '1',
          ...
          },
          {
            ...
            description:
              'Implement error handling and monitoring for API calls',
            status: 'todo',
            priority: 'medium',
            assignedTo: ['2'],
            createdBy: '2',
          ...
          },
          {
            ...
            description:
              'Implement meta tags, structured data, and SEO optimization',
            status: 'in-progress',
            priority: 'high',
            assignedTo: ['1'],
            createdBy: '1',
          ...
          },
          {
            ...
            description:
              'Optimize images, minify assets, and implement lazy loading',
            status: 'todo',
            priority: 'medium',
            assignedTo: ['2'],
            createdBy: '1',
          ...
          },
          {
            ...
            description:
              'Test and fix issues on Chrome, Firefox, Safari, and Edge',
            status: 'todo',
            priority: 'medium',
            assignedTo: ['2', '3'],
            createdBy: '1',
          ...
          },
          {
            ...
            description:
              'Conduct security audit and implement security headers',
            status: 'todo',
            priority: 'high',
            assignedTo: ['1', '3'],
            createdBy: '1',
          ...
          },
          {
            ...
            description:
              'This is a standalone task created for testing purposes',
            status: 'todo',
            priority: 'medium',
            assignedTo: ['1'],
            createdBy: '1',
