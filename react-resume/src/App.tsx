...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-primary-50 via-secondary-50 to-accent-50">
      ...
      <footer className="relative py-12 px-6bg-linear-to-br from-primary-900 via-secondary-900 to-accent-900 text-white">
        <div className="absolute inset-0 bg-black/20"></div>
        <div className="relative z-10 max-w-6xl mx-auto text-center">
          <div className="mb-6">
            <div className="w-20 h-20 mx-autobg-linear-to-br from-white to-gray-100 rounded-full flex items-center justify-center shadow-2xl mb-4">
              <div className="w-16 h-16bg-linear-to-br from-primary-500 to-secondary-500 rounded-full flex items-center justify-center">
